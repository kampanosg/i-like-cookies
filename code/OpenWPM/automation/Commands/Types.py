...
class DumpCookieNoticeCommand(BaseCommand):
    def __init__(self, suffix):
        self.suffix = suffix

    def __repr__(self):
        return "DumpCookieNoticeCommand({})".format(self.suffix)


class SaveCookieNoticeScreenshotCommand(BaseCommand):
    def __init__(self, suffix):
        self.suffix = suffix

    def __repr__(self):
        return "SaveCookieNoticeScreenshotCommand({})".format(self.suffix)
